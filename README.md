...
4. Tag each change with a primary domain, change-type tags, topical tags, deeper concept tags, milestone bundles, month, and quarter.
...
- `data/taxonomy_summary.json` — domain, concept, milestone, change-type, topical-tag, and storyline summaries.
- `data/timeline_summary.json` — month-by-month evolution across repos, concepts, milestones, and categories.
